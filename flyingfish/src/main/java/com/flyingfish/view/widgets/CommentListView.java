package com.flyingfish.view.widgets;
...
import com.flyingfish.spannable.CircleMovementMethod;
...
public class CommentListView extends LinearLayout {
    ...
    private List<ServiceInfoBean.DataBean.OpListBean> mDatas;
    ...
    public void setDatas(List<ServiceInfoBean.DataBean.OpListBean> datas){
        if(datas == null ){
            datas = new ArrayList<ServiceInfoBean.DataBean.OpListBean>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<ServiceInfoBean.DataBean.OpListBean> getDatas(){
        return mDatas;
    }
    ...
    private View getView(final int position){
        ...
        final ServiceInfoBean.DataBean.OpListBean bean = mDatas.get(position);
        ...
        builder.append(": ");
        //转换表情字符
        String contentBodyStr = bean.getComment_content();
