...
import com.flyingfish.base.YWActivity;
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, ArrayList<String> imgUrls) {
        if(imgUrls!=null && imgUrls.size()>0){
            ...
            for (int i=0; i<imgUrls.size(); i++){
                ...
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.width_6),
                        getResources().getDimensionPixelSize(R.dimen.width_6));
