package com.flyingfish.spannable;
...
import com.flyingfish.FlyfishApplication;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = FlyfishApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = FlyfishApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
