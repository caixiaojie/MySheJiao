...
public class SuperCustomToast {
    ...
    public void initView() {
        ...
        gapView.setLayoutParams(new LayoutParams(screenWidth, screenHeight / 11));
...
//
        LayoutInflater inflater =  LayoutInflater.from(mContext);
         layout = inflater.inflate(R.layout.super_toast_theme_light,
                null);
        layout.setLayoutParams(lp_WW);
        TextView title = (TextView) layout.findViewById(R.id.title);
        title.setText(msg);
        title.setTextColor(defaultTextColor);
        Animation starAnim = AnimationUtils.loadAnimation(mContext, R.anim.push_bottom_in);
        Animation endAnim = AnimationUtils.loadAnimation(mContext, R.anim.push_bottom_out);
        show(layout, null, starAnim,endAnim);
     }
