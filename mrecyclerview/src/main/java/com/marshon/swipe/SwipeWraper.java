...
import com.marshon.mrecyclerview.R;
...
public class SwipeWraper extends FrameLayout {
    @Deprecated
    ...
    private View swipeOutView;

    public SwipeWraper(View convertView) {
        this(convertView.getContext(),null);
        addView(convertView,0);
    }

    public void setSwipeOutView(View swipeOutView) {
        this.swipeOutView = swipeOutView;
    ...
    public SwipeWraper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeWraper(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mDragHelper = ViewDragHelper.create(this, mDragHelperCallback);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeWraper);
        int dragEdgeChoices = a.getInt(R.styleable.SwipeWraper_drag_edges, DRAG_RIGHT);
        mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a.getDimension(R.styleable.SwipeWraper_leftEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a.getDimension(R.styleable.SwipeWraper_rightEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a.getDimension(R.styleable.SwipeWraper_topEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(R.styleable.SwipeWraper_bottomEdgeSwipeOffset, 0);
        setClickToClose(a.getBoolean(R.styleable.SwipeWraper_clickToClose, mClickToClose));
        ...
        int ordinal = a.getInt(R.styleable.SwipeWraper_show_modes, ShowMode.PullOut.ordinal());
    ...
    public interface SwipeListener {
        public void onStartOpen(SwipeWraper layout);

        public void onOpen(SwipeWraper layout);

        public void onStartClose(SwipeWraper layout);

        public void onClose(SwipeWraper layout);

        public void onUpdate(SwipeWraper layout, int leftOffset, int topOffset);

        public void onHandRelease(SwipeWraper layout, float xvel, float yvel);
    }
    ...
    public static interface SwipeDenier {
         ...
         * gestures As a child of SwipeWraper
         * 
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners){
                l.onHandRelease(SwipeWraper.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(SwipeWraper.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(SwipeWraper.this);
                }
                mEventCounter = 0;
            }
    ...
    public interface OnLayout {
        public void onLayout(SwipeWraper v);
    }
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(!beforeCheck && mIsBeingDragged){
                    ...
                    //useful when SwipeWraper wrap a SwipeWraper or other gestural layout
                    return false;
                }
                break;
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(SwipeWraper.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, SwipeWraper.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, SwipeWraper.this, p, vId);
                }
                if (handled) {
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(SwipeWraper.this, target == surface);
            }
            return true;
        }
    }
     ...
     * {@link com.daimajia.swipe.SwipeWraper.ShowMode}.PullOut and
     * {@link com.daimajia.swipe.SwipeWraper.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link com.daimajia.swipe.SwipeWraper.Status} Open , Close or
     * Middle.
     */
    ...
    public interface DoubleClickListener {
        public void onDoubleClick(SwipeWraper layout, boolean surface);
    }
